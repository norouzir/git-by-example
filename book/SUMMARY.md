...
This file is the build manifest. The order of the links below is the order of
the book. Adding a chapter means adding a line here.

## Part 0. Using This Book

- [About This Book](part-00-using-this-book/about-this-book.md)
- [Chapter 1. How to Read This Book](part-00-using-this-book/01-how-to-read-this-book.md)
- [Chapter 2. The Sandbox](part-00-using-this-book/02-the-sandbox.md)
- [Chapter 3. Installing and Configuring Git](part-00-using-this-book/03-installing-and-configuring-git.md)

## Part 1. The Mental Model

- [Chapter 4. What Git Actually Stores](part-01-the-mental-model/04-what-git-actually-stores.md)
- [Chapter 5. The Three Areas](part-01-the-mental-model/05-the-three-areas.md)
- [Chapter 6. The Four Object Types](part-01-the-mental-model/06-the-four-object-types.md)
